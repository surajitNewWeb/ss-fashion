...
<div class="container">          
  <table class="table">
    <p><a class="btn btn-success" href="insertwomen.php">Add new</a></p>
    <thead>
      <tr>
        <th>Product Name</th>
        <th>Product Price</th>
    ...
    <tbody>
      <?php
     $sel="SELECT child.*,parent.product_name as pname FROM `women` as child LEFT JOIN women as parent
...
<td><img class="myimg" src="img/<?php echo $row['product_image']; ?>" ></td>
