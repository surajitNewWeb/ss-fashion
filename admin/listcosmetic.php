...
<div class="container">          
  <table class="table">
    <p><a class="btn btn-success" href="insertcosmetic.php">Add new</a></p>
    <thead>
      <tr>
        <th>Product Name</th>
        <th>Product Price</th>
    ...
    <tbody>
      <?php
     $sel="SELECT child.*,parent.product_name as pname FROM `cosmetic` as child LEFT JOIN cosmetic as parent
